...
const REGIMENS: Regimen[] = [
  ...
  },
  {
    ...
    phases: [
      ...
      {
        id: "t-phase", title: "T Phase \u2014 Paclitaxel (q14d \u00d7 4 cycles)",
        period: 14, count: 4,
        afterPhase: "ac-phase",
        drugs: [
          {
    ...
    phases: [
      {
        ...
        drugs: [
          ...
          },
          {
            ...
            rxnorm: "72962",    display: "docetaxel",
    ...
    extension: [
      {
        ...
        valueCodeableConcept: {
          coding: [{ system: regimen.intent.system ?? SNOMED, code: regimen.intent.code, display: regimen.intent.display }],
        },
      },
      {
        url: EXT_LINE,
        valueCodeableConcept: {
          coding: [{ system: TREATMENT_LINE, code: regimen.treatmentLine.code, display: regimen.treatmentLine.display }],
        },
      },
    ],
    action: actions,
