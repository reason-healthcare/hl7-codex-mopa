...
* valueCodeableConcept from RegimenIntentVS (required)
* valueCodeableConcept ^short = "Treatment intent for this patient-specific regimen order; coding system is SNOMED CT"
